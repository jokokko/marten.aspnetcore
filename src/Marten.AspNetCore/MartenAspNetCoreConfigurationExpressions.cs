...
{
	internal sealed class MartenAspNetCoreConfigurationExpressions : IMartenAspNetCoreConfigurationExpressions
	{
		private readonly IServiceCollection serviceCollection;

		public MartenAspNetCoreConfigurationExpressions(IServiceCollection serviceCollection)
		{
